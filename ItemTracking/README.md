...
2. 更改 `data/connect_config.json` 中**mqtt**和**httpUrl**
   - 格式如下
     ```json
     {
       ...
       "http url": "http://127.0.0.1/stream"
     }
     ```
...
## 執行結果
- index追蹤
![located_index](/ItemTracking/img/located_index.gif)
- 轉換為ID
![located_id](/ItemTracking/img/located_ID.gif)
- mqtt subscribe
  - topic：`Label`
  - message：`ID`
- mqtt publish
...
![輸送帶位置](/ItemTracking/img/輸送帶位置.jpg)
...
![追蹤示意圖](/ItemTracking/img/追蹤示意圖.jpg)
